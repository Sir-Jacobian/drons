...
2. используя вызовы программного интерфейса, сделать логирование текущих координат (широта, долгота и высота) квадрокоптера, начавшего исполнение миссии (рекомендуется логировать не чаще раза в секунду)
    - подсказка: редактировать понадобится только файл `kos/flight_controller/src/main_inspector.cpp`
...
Решение нужно отправить ответственному за проверку заданий эксперту. Способы коммуникации можно уточнить в чате соревнований.

На команду требуется одно решение квалификационного задания.

Если один из участников команды принимал участие в соревнованиях по кибериммунной автономности прошлых лет, прохождение квалификации не требуется. В этом случае достаточно сообщить организаторам об этом участнике.
...
3. Windows. На компьютере установлена ОС из семейства Windows, (опционально) [Docker Desktop](https://www.docker.com/products/docker-desktop/), Ubuntu 22.04 установлена в [WSL 2](https://learn.microsoft.com/ru-ru/windows/wsl/install).

Описанные рабочие окружения тестировались и подойдут для выполнения задания и дальнейшего участия в соревнованиях.

## Обратная связь

Технические вопросы по проекту и организационные вопросы по соревнованиям можно задать:

1. ВКонтакте [Кибериммунная автономность](https://vk.me/join/FyqbEBfAE9HcDA7Sp/0pWt9xNuVjkl6Bmgg=)
2. в Telegram-канале [Кибериммунная автономность. Техническая поддержка](https://t.me/+gduf-N4rGPw2YTUy).
